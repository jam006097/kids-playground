...
const utils_js_1 = require("../utils.js"); // getCookieはutils.jsにあると仮定
// グローバルなfetch関数をモックする
...
describe('FavoriteManager', () => {
    ...
    beforeEach(() => {
        ...
        favoriteManager = new favorite_1.FavoriteManager(utils_js_1.getCookie);
        // fetchのモックをクリア
        fetch.mockClear();
        // csrftokenをクッキーに設定
    ...
    // シナリオ: お気に入りに追加する
    test('お気に入りに追加するリクエストを送信し、ボタンの表示を更新する', () => __awaiter(void 0, void 0, void 0, function* () {
        // 実行: toggleFavoriteを呼び出す
        yield favoriteManager.toggleFavorite(mockButton, '123');
    ...
    // シナリオ: お気に入りから削除する
    test('お気に入りから削除するリクエストを送信し、ボタンの表示を更新する', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('window.favorite_idsの更新', () => {
        ...
        test('お気に入り追加時にwindow.favorite_idsにIDが追加される', () => __awaiter(void 0, void 0, void 0, function* () {
            // 実行
            yield favoriteManager.toggleFavorite(mockButton, '123');
            // 検証
        ...
        test('お気に入り削除時にwindow.favorite_idsからIDが削除される', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // シナリオ: APIエラーが発生した場合
    test('APIエラーが発生した場合、アラートを表示する', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test('ネットワークエラーが発生した場合、アラートを表示する', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // シナリオ: ボタンが無効化されている場合
    test('ボタンが無効化されている場合、処理を続行しない', () => __awaiter(void 0, void 0, void 0, function* () {
        // 準備: ボタンを無効化する
